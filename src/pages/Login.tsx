// src/pages/Login.tsx — FULL-PAGE IMAGE BACKGROUND VERSION
// Put your wide hero image in /public/login-hero.png (1920x1080+ recommended)

import React, { useState } from 'react';
import { Link, useNavigate, useLocation } from 'react-router-dom';
import { motion } from 'framer-motion';
import { Eye, EyeOff, Mail, Lock, Smartphone, Shield, Chrome, ShoppingBag } from 'lucide-react';
...
const Login: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* Content (login card on the right) */}
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {!requiresTwoFactor ? (
                ...
                // 2FA STEP
                <div>
                  <label htmlFor="totpToken" className="block text-sm font-medium text-gray-800 mb-1.5">
                    Authentication Code
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
