...
const CheckoutPage: React.FC = () => {
  ...
  if (cartLoading) {
    return (
      <div className="min-h-[100svh] bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center overflow-x-hidden">
        <div className="text-center bg-white p-6 sm:p-8 rounded-2xl shadow-lg w-[92%] max-w-md">
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-[100svh] bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-3 sm:px-4 overflow-x-hidden">
  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-[100svh] bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-3 sm:px-4 overflow-x-hidden">
        <div className="text-center w-full max-w-md mx-auto p-6 sm:p-8 bg-white rounded-2xl shadow-xl">
  ...
  return (
    <div className="min-h-[100svh] bg-gradient-to-br from-gray-50 via-white to-blue-50 overflow-x-hidden">
      <div className="max-w-7xl w-full mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8">
        {/* Header */}
        ...
        <form onSubmit={onSubmit} className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8">
          {/* Order Summary (left on lg) */}
